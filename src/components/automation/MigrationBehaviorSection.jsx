...
export default function MigrationBehaviorSection({
  ...
  return (
    <div className={GLASS_CARD + ' overflow-hidden'}>
      ...
      >
        <h2 className="text-xl font-bold text-white">How to Migrate</h2>
        <ChevronDown
          size={ICON.section}
          className={`text-gray-400 transition-transform duration-200 ${!collapsedSections.migrationBehaviorSection ? 'rotate-180' : ''}`}
        />
      </button>
      ...
      {!collapsedSections.migrationBehaviorSection && (
        <div className="space-y-6">
          ...
          <div className="border-t border-slate-700 pt-4">
            <h3 className="text-base font-bold text-white mb-3">Safety Checks</h3>
