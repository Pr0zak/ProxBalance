      ...
      >
        <div>
          {embedded
            ...
            : <h2 className="text-xl font-bold text-pb-text dark:text-white">Smart Migrations</h2>
          }
        ...
        <div className="space-y-4">
          ...
          {imConfig?.enabled !== false && (
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-pb-text dark:text-gray-300 mb-2">Intelligence Level</label>
                  ...
                  {INTELLIGENCE_LEVELS.map(level => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="text-xs text-pb-text2 dark:text-gray-400 mt-1">{level.detail}</div>
                      </button>
                    );
                  })}
                </div>
