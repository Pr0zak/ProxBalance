                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 bg-gray-700 text-gray-200 rounded text-sm hover:bg-gray-600 flex items-center justify-center gap-1.5"
                      >
                        <X size={14} />
                        Cancel
                      </button>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 bg-gray-700 text-gray-200 rounded text-sm hover:bg-gray-600 font-medium flex items-center justify-center gap-1.5"
                      >
                        <X size={14} />
