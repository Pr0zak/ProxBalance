...
export default function ScheduleSection({
  ...
  return (
    <div className={GLASS_CARD + ' overflow-hidden'}>
      ...
      >
        <h2 className="text-xl font-bold text-white">When to Migrate</h2>
        <ChevronDown
          size={ICON.section}
          className={`text-gray-400 transition-transform duration-200 ${!collapsedSections.scheduleSection ? 'rotate-180' : ''}`}
        />
      </button>
