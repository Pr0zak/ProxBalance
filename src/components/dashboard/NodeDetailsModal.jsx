        ...
        <div className="flex items-center justify-between p-4 sm:p-6 border-b border-slate-700 shrink-0">
          <div className="flex items-center gap-2 sm:gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h3 className="text-base sm:text-xl font-bold text-white truncate">{selectedNode.name}</h3>
              <p className="text-xs sm:text-sm text-gray-400">Node Details</p>
            </div>
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-6">
            ...
            <div className="relative overflow-hidden bg-gradient-to-br from-blue-900/20 to-blue-800/20 rounded-lg p-4">
              ...
              <div className="relative z-10">
                ...
                <div className="text-xs text-gray-400">{selectedNode.cpu_cores || 0} cores</div>
              </div>
            </div>
            <div className="relative overflow-hidden bg-gradient-to-br from-purple-900/20 to-purple-800/20 rounded-lg p-4">
              ...
              <div className="relative z-10">
                ...
                <div className="text-xs text-gray-400">{((selectedNode.mem_used || 0) / 1073741824).toFixed(1)} GB / {((selectedNode.mem_total || 0) / 1073741824).toFixed(1)} GB</div>
              </div>
            </div>
            <div className="relative overflow-hidden bg-gradient-to-br from-orange-900/20 to-orange-800/20 rounded-lg p-4">
              ...
              <div className="relative z-10">
                <div className="text-sm text-gray-300 mb-1">IOWait</div>
                <div className="text-2xl font-bold text-white">
                  {(selectedNode.metrics?.current_iowait || 0).toFixed(1)}%
                </div>
                <div className="text-xs text-gray-400">I/O latency</div>
              </div>
            </div>
          </div>
          ...
          {selectedNode.metrics && (
            <div className="mb-6 p-4 bg-blue-900/20 border border-blue-800 rounded-lg">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h4 className="text-sm font-semibold text-white">Migration Target Suitability</h4>
              </div>

              {/* Overall Score Display */}
              {nodeScores && nodeScores[selectedNode.name] && (
                <div className="mb-3 p-3 bg-slate-800 rounded-lg border-2 border-blue-600">
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-xs text-gray-400 mb-1">Suitability Rating</div>
                  ...
                  {nodeScores[selectedNode.name].penalty_categories && (() => {
                    ...
                    return (
                      <div className="mt-2 pt-2 border-t border-slate-700">
                        <div className="text-xs text-gray-400 mb-1.5">Penalty Breakdown ({total} pts total)</div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div className="bg-slate-800 rounded p-2">
                  <div className="text-xs text-gray-400 mb-1">CPU Score</div>
                ...
                <div className="bg-slate-800 rounded p-2">
                  <div className="text-xs text-gray-400 mb-1">IOWait Score</div>
