...
export default function ScoringExplainer({ penaltyConfig, setCurrentPage, setOpenPenaltyConfigOnAutomation }) {
  return (
    <div className="space-y-4">
      ...
      {/* Score Legend */}
      <div>
        <h5 className="text-xs font-semibold text-gray-300 mb-1.5">Suitability Rating Scale</h5>
      ...
      <div className="p-2.5 bg-gray-700/50 rounded">
        <h5 className="text-xs font-semibold text-gray-300 mb-1">Your Configuration</h5>
      ...
      <ul className="ml-4 space-y-1 text-gray-400 text-xs list-disc">
      ...
      <div className="text-xs">
        <button
          ...
          className="text-blue-400 hover:text-blue-200 underline font-semibold"
        >
