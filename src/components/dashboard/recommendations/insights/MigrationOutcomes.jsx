  ...
  return (
    <div className="space-y-2">
      {outcomes.map((outcome, idx) => {
        ...
        return (
          <div key={idx} className={`text-xs p-2.5 rounded border ${isPending ? 'border-amber-800 bg-amber-900/20' : 'border-slate-700 bg-gray-800/50'}`}>
            ...
            {!isPending && post && (
              <div className="grid grid-cols-2 gap-2">
                <div>
                  <div className="text-[10px] text-gray-500 mb-0.5">Source CPU</div>
                  <div className="flex items-center gap-1">
                    <span className="text-gray-400">{pre.source_node?.cpu}%</span>
                ...
                <div>
                  <div className="text-[10px] text-gray-500 mb-0.5">Source Memory</div>
                  <div className="flex items-center gap-1">
                    <span className="text-gray-400">{pre.source_node?.mem}%</span>
                    <ArrowRight size={8} className="text-gray-400" />
