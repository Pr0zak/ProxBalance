  ...
  return (
    <div className={`mb-4 rounded-xl p-3 sm:p-4 ${
      summary.urgency === 'high'
        ...
        ? 'bg-green-50 dark:bg-green-900/20 border border-green-300 dark:border-green-700/50'
        : INNER_CARD
    }`}>
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-sm text-pb-text dark:text-white">
      ...
      <div className="w-full bg-pb-surface2 dark:bg-slate-700 rounded-full h-2 mb-2">
        <div
      ...
      <div className="flex flex-wrap gap-x-4 gap-y-1 text-xs text-pb-text2 dark:text-gray-400">
