  ...
  return (
    <div className="mt-4">
      ...
      >
        ...
        <span className="text-xs text-pb-text2 dark:text-gray-500">— Why weren't these guests recommended?</span>
      </button>
      {!collapsedSections.skippedGuests && (
        <div className="mt-2 space-y-1">
          ...
          {recommendationData.skipped_guests.length > 20 && (
            <div className="text-xs text-pb-text2 dark:text-gray-500 text-center py-1">
