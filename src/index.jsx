        ...
        <div className="max-w-7xl mx-auto">
          <div className={`flex items-center justify-between mb-6 ${GLASS_CARD}`}>
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl"><span className="font-light text-gray-900 dark:text-gray-200">Prox</span><span className="font-extrabold bg-gradient-to-r from-blue-900 to-blue-600 dark:from-blue-400 dark:to-blue-500 bg-clip-text text-transparent">Balance</span></h1>
            </div>
            <div className="flex items-center gap-3">
