...
`) || "" }, /* @__PURE__ */ React.createElement(AlertTriangle, { size: 10 }), "Risk: ", rec.risk_level === "very_high" ? "Very High" : rec.risk_level.charAt(0).toUpperCase() + rec.risk_level.slice(1), "(", rec.risk_score, "/100)"), rec.has_conflict && /* @__PURE__ */ React.createElement(
    ...
    ), collapsedSections[`details-${idx}`] && /* @__PURE__ */ React.createElement("div", { className: "mt-2 p-3 bg-gradient-to-r from-indigo-50 to-blue-50 dark:from-indigo-950/40 dark:to-blue-950/30 border border-indigo-200 dark:border-indigo-800/60 rounded text-xs space-y-3" }, /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-4" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "font-semibold text-red-600 dark:text-red-400 mb-1 flex items-center gap-1" }, "Source: ", rec.source_node, rec.trend_evidence?.available && (() => {
      let dir = rec.trend_evidence.source_node_trend?.cpu_direction;
    ...
    })()), /* @__PURE__ */ React.createElement("div", { className: "space-y-0.5 text-gray-600 dark:text-gray-400" }, rec.score_details && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", null, "Score: ", rec.score_details.source?.total_score?.toFixed(1) || "N/A"), /* @__PURE__ */ React.createElement("div", { className: "text-[10px] mt-1 font-medium text-gray-500 dark:text-gray-500" }, "Penalties:"), Object.entries(rec.score_details.source?.penalties || {}).filter(([, v]) => v > 0).map(([key2, val]) => /* @__PURE__ */ React.createElement("div", { key: key2, className: "flex justify-between" }, /* @__PURE__ */ React.createElement("span", null, key2.replace(/_/g, " ")), /* @__PURE__ */ React.createElement("span", { className: "text-red-500 dark:text-red-400 font-mono" }, "+", val))), Object.values(rec.score_details.source?.penalties || {}).every((v) => v === 0) && /* @__PURE__ */ React.createElement("div", { className: "text-green-600 dark:text-green-400" }, "No penalties")), rec.trend_evidence?.available && /* @__PURE__ */ React.createElement("div", { className: rec.score_details ? "mt-2 pt-2 border-t border-indigo-200/50 dark:border-indigo-800/40" : "" }, /* @__PURE__ */ React.createElement("div", { className: "text-[10px] font-medium text-gray-500 dark:text-gray-500 mb-0.5" }, "Trends:"), /* @__PURE__ */ React.createElement("div", null, "CPU: ", rec.trend_evidence.source_node_trend?.cpu_trend || "N/A"), /* @__PURE__ */ React.createElement("div", null, "Memory: ", rec.trend_evidence.source_node_trend?.mem_trend || "N/A"), /* @__PURE__ */ React.createElement("div", null, "Stability: ", rec.trend_evidence.source_node_trend?.stability_score || "?", "/100"), rec.trend_evidence.source_node_trend?.above_baseline && /* @__PURE__ */ React.createElement("div", { className: "text-orange-600 dark:text-orange-400 font-medium" }, "Above baseline (", rec.trend_evidence.source_node_trend.baseline_deviation_sigma?.toFixed(1) || "?", "\u03C3)")))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "font-semibold text-green-600 dark:text-green-400 mb-1 flex items-center gap-1" }, "Target: ", rec.target_node, rec.trend_evidence?.available && (() => {
      let dir = rec.trend_evidence.target_node_trend?.cpu_direction;
    ...
    })()), /* @__PURE__ */ React.createElement("div", { className: "space-y-0.5 text-gray-600 dark:text-gray-400" }, rec.score_details && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", null, "Score: ", rec.score_details.target?.total_score?.toFixed(1) || "N/A"), /* @__PURE__ */ React.createElement("div", { className: "text-[10px] mt-1 font-medium text-gray-500 dark:text-gray-500" }, "Penalties:"), Object.entries(rec.score_details.target?.penalties || {}).filter(([, v]) => v > 0).map(([key2, val]) => /* @__PURE__ */ React.createElement("div", { key: key2, className: "flex justify-between" }, /* @__PURE__ */ React.createElement("span", null, key2.replace(/_/g, " ")), /* @__PURE__ */ React.createElement("span", { className: "text-red-500 dark:text-red-400 font-mono" }, "+", val))), Object.values(rec.score_details.target?.penalties || {}).every((v) => v === 0) && /* @__PURE__ */ React.createElement("div", { className: "text-green-600 dark:text-green-400" }, "No penalties")), rec.trend_evidence?.available && /* @__PURE__ */ React.createElement("div", { className: rec.score_details ? "mt-2 pt-2 border-t border-indigo-200/50 dark:border-indigo-800/40" : "" }, /* @__PURE__ */ React.createElement("div", { className: "text-[10px] font-medium text-gray-500 dark:text-gray-500 mb-0.5" }, "Trends:"), /* @__PURE__ */ React.createElement("div", null, "CPU: ", rec.trend_evidence.target_node_trend?.cpu_trend || "N/A"), /* @__PURE__ */ React.createElement("div", null, "Memory: ", rec.trend_evidence.target_node_trend?.mem_trend || "N/A"), /* @__PURE__ */ React.createElement("div", null, "Stability: ", rec.trend_evidence.target_node_trend?.stability_score || "?", "/100"))))), rec.score_details?.target?.metrics && /* @__PURE__ */ React.createElement("div", { className: "pt-2 border-t border-indigo-200 dark:border-indigo-800/60" }, /* @__PURE__ */ React.createElement("div", { className: "text-[10px] font-medium text-gray-500 dark:text-gray-500 mb-1" }, "After migration on ", rec.target_node, ":"), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-x-4 gap-y-0.5 text-gray-600 dark:text-gray-400" }, /* @__PURE__ */ React.createElement("span", null, "CPU: ", rec.score_details.target.metrics.predicted_cpu, "%"), /* @__PURE__ */ React.createElement("span", null, "Memory: ", rec.score_details.target.metrics.predicted_mem, "%"), /* @__PURE__ */ React.createElement("span", null, "Headroom: ", rec.score_details.target.metrics.cpu_headroom, "% CPU, ", rec.score_details.target.metrics.mem_headroom, "% mem"))), rec.score_details && (rec.score_details.target?.trend_analysis || rec.score_details.source?.trend_analysis) && /* @__PURE__ */ React.createElement("div", { className: "pt-2 border-t border-indigo-200 dark:border-indigo-800/60 flex flex-wrap gap-2" }, rec.score_details.source?.trend_analysis?.cpu_stability_factor != null && rec.score_details.source.trend_analysis.cpu_stability_factor !== 1 && /* @__PURE__ */ React.createElement(
      "span",
      {
      ...
      "x"
    )), rec.trend_evidence?.guest_trend && /* @__PURE__ */ React.createElement("div", { className: "pt-2 border-t border-indigo-200 dark:border-indigo-800/60" }, /* @__PURE__ */ React.createElement("div", { className: "font-medium text-gray-700 dark:text-gray-300 mb-1" }, "Guest Behavior"), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-2" }, /* @__PURE__ */ React.createElement("span", { className: `px-2 py-0.5 rounded text-[10px] font-bold ${rec.trend_evidence.guest_trend.behavior === "growing" ? "bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300" : rec.trend_evidence.guest_trend.behavior === "bursty" ? "bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-300" : rec.trend_evidence.guest_trend.behavior === "steady" ? "bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300" : "bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400"}` }, rec.trend_evidence.guest_trend.behavior || "unknown"), /* @__PURE__ */ React.createElement("span", { className: "text-gray-500 dark:text-gray-400" }, "CPU: ", rec.trend_evidence.guest_trend.cpu_growth_rate || "N/A"), rec.trend_evidence.guest_trend.previous_migrations > 0 && /* @__PURE__ */ React.createElement("span", { className: "text-gray-500 dark:text-gray-400" }, "| Migrated ", rec.trend_evidence.guest_trend.previous_migrations, "x before"), rec.trend_evidence.guest_trend.peak_hours?.length > 0 && /* @__PURE__ */ React.createElement("span", { className: "text-gray-500 dark:text-gray-400" }, "| Peak hours: ", rec.trend_evidence.guest_trend.peak_hours.map((h) => `${h}:00`).join(", ")))), rec.trend_evidence?.decision_factors?.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "pt-2 border-t border-indigo-200 dark:border-indigo-800/60" }, /* @__PURE__ */ React.createElement("div", { className: "font-medium text-gray-700 dark:text-gray-300 mb-1" }, "Decision Factors"), /* @__PURE__ */ React.createElement("div", { className: "space-y-1" }, rec.trend_evidence.decision_factors.map((f, i) => /* @__PURE__ */ React.createElement("div", { key: i, className: "flex items-start gap-2" }, /* @__PURE__ */ React.createElement("span", { className: `shrink-0 w-1.5 h-1.5 rounded-full mt-1.5 ${f.type === "problem" ? "bg-red-500" : f.type === "positive" ? "bg-green-500" : f.type === "concern" ? "bg-yellow-500" : "bg-gray-400"}` }), /* @__PURE__ */ React.createElement("span", { className: "text-gray-600 dark:text-gray-400" }, f.factor, f.weight === "high" && /* @__PURE__ */ React.createElement("span", { className: "ml-1 text-[9px] font-bold text-gray-400 dark:text-gray-500" }, "(HIGH)")))))), rec.trend_evidence?.data_quality && /* @__PURE__ */ React.createElement("div", { className: "text-[10px] text-gray-400 dark:text-gray-500 pt-1" }, "Based on ", rec.trend_evidence.data_quality.node_history_days || 0, " days of node history,", " ", rec.trend_evidence.data_quality.guest_history_days || 0, " days of guest history.", " ", rec.trend_evidence.data_quality.confidence_note))), /* @__PURE__ */ React.createElement("div", { className: "mt-1" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-center gap-3" }, /* @__PURE__ */ React.createElement(
      "button",
      {
        onClick: (e) => {
          e.stopPropagation();
