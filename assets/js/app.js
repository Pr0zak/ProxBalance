...
This will restart the background data collection process.`) && fetch(`${API_BASE}/system/restart-service`, {
  ...
  function AutomationStatusSection({
    ...
    return automationStatus ? /* @__PURE__ */ React.createElement("div", { className: "bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-850 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-4 sm:p-6 mb-6 overflow-hidden" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between mb-3" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3 min-w-0" }, /* @__PURE__ */ React.createElement("div", { className: `p-2.5 rounded-lg shadow-md shrink-0 ${automationStatus.enabled ? "bg-gradient-to-br from-green-600 to-emerald-600" : "bg-gradient-to-br from-gray-500 to-gray-600"}` }, /* @__PURE__ */ React.createElement(Clock, { size: 24, className: "text-white" })), /* @__PURE__ */ React.createElement("div", { className: "min-w-0" }, /* @__PURE__ */ React.createElement("h2", { className: "text-lg sm:text-2xl font-bold text-gray-900 dark:text-white truncate" }, "Automated Migrations"), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-600 dark:text-gray-400 mt-0.5" }, "Scheduled automatic balancing")), /* @__PURE__ */ React.createElement(
      ...
      let points = scoreHistory.map((e) => e.cluster_health).filter((v) => v != null);
      if (points.length < 2) return null;
      let min = Math.min(...points), range = Math.max(...points) - min || 1, w = 400, h = 80, pad = 4, linePoints = points.map((v, i) => {
        let x = pad + i / (points.length - 1) * (w - 2 * pad), y = h - pad - (v - min) / range * (h - 2 * pad);
        return `${x},${y}`;
      }).join(" "), areaPoints = `${pad},${h - pad} ${linePoints} ${w - pad},${h - pad}`, latest = points[points.length - 1], earliest = points[0], trend = latest - earliest;
      return /* @__PURE__ */ React.createElement("div", { className: "bg-white dark:bg-gray-700 rounded-lg p-4 border border-gray-200 dark:border-gray-600 mb-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between mb-2" }, /* @__PURE__ */ React.createElement("h4", { className: "text-sm font-semibold text-gray-700 dark:text-gray-300" }, "Cluster Health"), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 text-xs" }, /* @__PURE__ */ React.createElement("span", { className: "font-bold text-gray-900 dark:text-white" }, latest.toFixed(1), "%"), /* @__PURE__ */ React.createElement("span", { className: `font-semibold ${trend >= 0 ? "text-green-600 dark:text-green-400" : "text-red-600 dark:text-red-400"}` }, trend >= 0 ? "+" : "", trend.toFixed(1)))), /* @__PURE__ */ React.createElement("svg", { viewBox: `0 0 ${w} ${h}`, className: "w-full", style: { height: "80px" }, preserveAspectRatio: "none" }, /* @__PURE__ */ React.createElement("polygon", { points: areaPoints, fill: "url(#healthGrad)", opacity: "0.3" }), /* @__PURE__ */ React.createElement("polyline", { points: linePoints, fill: "none", stroke: "#3b82f6", strokeWidth: "2", strokeLinejoin: "round" }), /* @__PURE__ */ React.createElement("defs", null, /* @__PURE__ */ React.createElement("linearGradient", { id: "healthGrad", x1: "0", y1: "0", x2: "0", y2: "1" }, /* @__PURE__ */ React.createElement("stop", { offset: "0%", stopColor: "#3b82f6" }), /* @__PURE__ */ React.createElement("stop", { offset: "100%", stopColor: "#3b82f6", stopOpacity: "0" })))), /* @__PURE__ */ React.createElement("div", { className: "flex justify-between text-[10px] text-gray-400 dark:text-gray-500 mt-1" }, /* @__PURE__ */ React.createElement("span", null, scoreHistory.length > 0 ? new Date(scoreHistory[0].timestamp).toLocaleDateString() : ""), /* @__PURE__ */ React.createElement("span", null, scoreHistory.length > 0 ? new Date(scoreHistory[scoreHistory.length - 1].timestamp).toLocaleDateString() : "")));
    })(), automationStatus.intelligent_tracking?.enabled && automationStatus.intelligent_tracking?.learning_progress && (() => {
      let lp = automationStatus.intelligent_tracking.learning_progress, pct = lp.min_required_hours > 0 ? Math.min(100, Math.round(lp.data_collection_hours / lp.min_required_hours * 100)) : 100, isReady = pct >= 100, level = automationStatus.intelligent_tracking.intelligence_level;
      return /* @__PURE__ */ React.createElement("div", { className: "bg-white dark:bg-gray-700 rounded-lg p-4 border border-gray-200 dark:border-gray-600 mb-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between mb-2" }, /* @__PURE__ */ React.createElement("h4", { className: "text-sm font-semibold text-gray-700 dark:text-gray-300 flex items-center gap-2" }, /* @__PURE__ */ React.createElement(Info, { size: 14, className: "text-blue-500" }), "Learning Progress", level && /* @__PURE__ */ React.createElement("span", { className: "px-1.5 py-0.5 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-[10px] font-semibold rounded capitalize" }, level)), /* @__PURE__ */ React.createElement("span", { className: `text-xs font-semibold ${isReady ? "text-green-600 dark:text-green-400" : "text-blue-600 dark:text-blue-400"}` }, isReady ? "Ready" : "Collecting data...")), lp.min_required_hours > 0 && /* @__PURE__ */ React.createElement("div", { className: "mb-2" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between text-[10px] text-gray-500 dark:text-gray-400 mb-1" }, /* @__PURE__ */ React.createElement("span", null, "Data collection: ", Math.round(lp.data_collection_hours), "h of ", lp.min_required_hours, "h"), /* @__PURE__ */ React.createElement("span", null, pct, "%")), /* @__PURE__ */ React.createElement("div", { className: "w-full bg-gray-200 dark:bg-gray-600 rounded-full h-1.5" }, /* @__PURE__ */ React.createElement(
        "div",
        {
          className: `h-1.5 rounded-full transition-all ${isReady ? "bg-green-500" : "bg-blue-500"}`,
          style: { width: `${pct}%` }
        }
      ))), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-3 text-[10px] text-gray-600 dark:text-gray-400" }, lp.guest_profiles_count > 0 && /* @__PURE__ */ React.createElement("span", null, lp.guest_profiles_count, " guest profile", lp.guest_profiles_count !== 1 ? "s" : "", " built"), lp.outcomes_count > 0 && /* @__PURE__ */ React.createElement("span", null, lp.outcomes_count, " migration outcome", lp.outcomes_count !== 1 ? "s" : "", " recorded"), lp.avg_prediction_accuracy != null && /* @__PURE__ */ React.createElement("span", null, "Avg accuracy: ", lp.avg_prediction_accuracy, "%")));
      ...
      let getOrder = (d) => d.action === "executed" || d.action === "pending" || d.action === "failed" ? 0 : d.action === "observing" || d.action === "deferred" ? 1 : d.action === "skipped" ? 2 : 3, orderA = getOrder(a), orderB = getOrder(b);
...
`), blob = new Blob([csv], { type: "text/csv" }), url = window.URL.createObjectURL(blob), a = document.createElement("a");
  ...
  var { useState: useState8, useEffect: useEffect2 } = React, useIsMobile = (breakpoint = 768) => {
    let [isMobile, setIsMobile] = useState8(
...
Proceed anyway?`) || !confirm(`Rollback ${rec.type} ${rec.vmid} (${rec.name}) back to ${info.original_node}?`)) return;
  ...
  function WorkloadPatterns({ API_BASE: API_BASE4, active }) {
    let [patterns, setPatterns] = useState9(null), [loading, setLoading] = useState9(!1);
    return useEffect3(() => {
  ...
  function MigrationOutcomes({ API_BASE: API_BASE4, active }) {
    let [outcomes, setOutcomes] = useState10(null), [loading, setLoading] = useState10(!1);
    return useEffect4(() => {
  ...
  var { useState: useState11, useEffect: useEffect5 } = React;
  function RecommendationHistory({ API_BASE: API_BASE4, active }) {
    let [historyData, setHistoryData] = useState11(null), [loading, setLoading] = useState11(!1), [hours, setHours] = useState11(24);
    if (useEffect5(() => {
      if (!active) return;
      let cancelled = !1;
...
Recs: ${recCounts[i]}` }, /* @__PURE__ */ React.createElement("div", { className: "w-full flex flex-col justify-end h-16" }, /* @__PURE__ */ React.createElement("div", { className: "w-full bg-green-400 dark:bg-green-500 rounded-t-sm opacity-60 group-hover:opacity-100 transition-opacity", style: { height: `${healthPct}%`, minHeight: healthPct > 0 ? "1px" : "0" } })), recPct > 0 && /* @__PURE__ */ React.createElement("div", { className: "absolute bottom-0 w-1 bg-orange-500 rounded-t-sm opacity-70", style: { height: `${recPct * 0.6}%`, minHeight: "2px" } }));
  ...
  var { useState: useState12, useEffect: useEffect6, useRef: useRef2 } = React, TABS = [
  ...
  function InsightsDrawer({
    ...
    let [activeTab, setActiveTab] = useState12("impact"), drawerRef = useRef2(null);
    return useEffect6(() => {
      if (!open) return;
      let handleKey = (e) => {
  ...
  function MigrationRecommendationsSection({
    ...
    let [recFilterConfidence, setRecFilterConfidence] = useState13(""), [recFilterTargetNode, setRecFilterTargetNode] = useState13(""), [recFilterSourceNode, setRecFilterSourceNode] = useState13(""), [recSortBy, setRecSortBy] = useState13(""), [recSortDir, setRecSortDir] = useState13("desc"), [showRecFilters, setShowRecFilters] = useState13(!1), [showInsights, setShowInsights] = useState13(!1), [showThresholdPopover, setShowThresholdPopover] = useState13(!1), isMobile = useIsMobile_default(), hasThresholdDiff = thresholdSuggestions && thresholdSuggestions.confidence && (Math.abs((thresholdSuggestions.suggested_cpu_threshold || 60) - (cpuThreshold || 60)) >= 3 || Math.abs((thresholdSuggestions.suggested_mem_threshold || 70) - (memThreshold || 70)) >= 3), getFilteredRecs = () => {
